...
urlpatterns = [
    ...
    path('medicamentos/', views.MedicamentosViewSet.as_view()),
    path('medicamentos/<int:pk>', views.MedicamentosRetrieveViewSet.as_view()),
    path('laboratorios/', views.LaboratoriosViewSet.as_view()),
    path('laboratorios/<int:pk>', views.LaboratoriosRetrieveViewSet.as_view())
]